...
<title>Welcome to BPL Medical Technologies</title>
<!-- CSS src -->
...
<section class="web_device"> 
  ...
  <article id="wrapper_inner"> 
    ...
    <ul class="rslides" id="slider2">
      <li><a href="#"><img src="images/newfeed.jpg" alt=""></a></li>
    </ul>
    <!-- Header Start -->
  ...
  <article class="news_content_wrapper">
    <section class="center_cont">
      <section class="newsevent_thumbnail_section">
        <figure class="newsevent_thumb_container"> <a href="javascript:void(0);">
          <figure> <img src="images/news_img.jpg">
            <figcaption>
              <p><span class="hc_effect1">More</span></p>
            </figcaption>
          </figure>
          </a>
          <h3><strong>NANMA RAAV</strong> Hyderabad<br>
            May 6 - 8, 2016</h3>
        </figure>
        <figure class="newsevent_thumb_container"> <a href="javascript:void(0);">
      ...
      <section class="newsevent_thumbnail_section">
        <figure class="newsevent_thumb_container"> <a href="javascript:void(0);">
          ...
          <h3><strong>NANMA RAAV</strong><br>
            May 6 - 8, 2016</h3>
        </figure>
        <figure class="newsevent_thumb_container"> <a href="javascript:void(0);">
          <figure> <img src="images/news1.jpg">
